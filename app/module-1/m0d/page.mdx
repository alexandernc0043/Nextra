...
<Steps>
    ...
    **Example(s):**
    ...
    > [!TIP]
    >
    > The `href` attribute stands for hypertext refrence and the value of it is where your link will go.
...
<Steps>
   ...
   > [!NOTE]
   >
   > In the future your GITHUB_USER_NAME.github.io folder will be referred to as the "root" of your website
   ...
   > [!NOTE]
   > 
   > GitHub won't track folders with no files inside. You can add a README.md file if you want to have it be tracked but that's not required.
</Steps>
    ...
    **Port:** 22
    ...
    <FileTree>
      <FileTree.Folder name="public_html" defaultOpen>
          <FileTree.Folder name="itis3135" defaultOpen>
